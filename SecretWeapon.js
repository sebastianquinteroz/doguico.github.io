...
const countriesList = {
  ...
  CL: new Country("CL", "Chile", 44, "CLP", 0.19, new PayinConfiguration(["MC", "MD", "VI", "VD", "DC", "AE", "PR", "CM", "MG", "MH"], ["WP", "IO"], ["SP"]), new PayoutConfiguration()),
  CM: new Country("CM", "Cameroon", 45, "XAF", 0, new PayinConfiguration(["MC", "VI", "VD","MD"], ["MW"], null)),
  CN: new Country("CN", "China", 46, "CNY", 0, new PayinConfiguration(null, ["EF", "UP"], null), new PayoutConfiguration()),
  CO: new Country("CO", "Colombia", 47, "COP", 0.19, new PayinConfiguration(["VI", "MC", "VD", "MD", "AE", "DC", "CZ"], ["PC"], ["EY", "BU", "DA"]), new PayoutConfiguration([new PayoutTax(4, 'GMF')])),
  CR: new Country("CR", "Costa Rica", 48, "CRC", 0.13, new PayinConfiguration(["VI","VD","MC","MD","JC","AE","DC","DI"],["TU","CX", "PU"], null), new PayoutConfiguration()),
  DO: new Country("DO", "Dominican Republic", 59, "DOP", 0, new PayinConfiguration(["VI","VD","MC","MD","AE", "DC", "DI"], null, ["ZP"]), new PayoutConfiguration()),
  EC: new Country("EC", "Ecuador", 61, "USD", 0.12, new PayinConfiguration(["VI","VD","MC","MD", "AE","AA"], null, ["EF"]), new PayoutConfiguration()),
  EG: new Country("EG", "Egypt", 63, "EGP", 0.14, new PayinConfiguration(["VI", "MC","VD", "MD"], null, ["FW", "ME"]),  new PayoutConfiguration()),
  GH: new Country("GH", "Ghana", 79, "GHS", 0, new PayinConfiguration(["VI","VD", "MC","MD"], ["MW"], null)),
  GT: new Country("GT", "Guatemala", 88, "GTQ", 0, new PayinConfiguration(["VI","VD", "MC","MD","AE","DC","DI","JC"], null, null)),
  ID: new Country("ID", "Indonesia", 98, "IDR", 0.1, new PayinConfiguration(["VI", "MC", "VD", "MD", "JC", "AE"], ["VS","IO","EB"], ["RO", "AL"], ["XW", "OV","DN","LK"])),
  ...
  MY: new Country("MY", "Malaysia", 151, "MYR", 0, new PayinConfiguration(["VI","VD","MC","MD"], ["IO"], ["SL"],["MO","TG","GY","SL"])),
  NG: new Country("NG", "Nigeria", 157, "NGN", 0, new PayinConfiguration(["VI", "MC", "VD", "MD", "VE"], [ "IO"], null),  new PayoutConfiguration()),
  PA: new Country("PA", "Panama", 166, "USD", 0, new PayinConfiguration(["VI","VD","MC","MD", "CV", "JC","AE","DI"],["NQ"],["PV"]), new PayoutConfiguration()),
  PE: new Country("PE", "Peru", 167, "PEN", 0.18, new PayinConfiguration(["VI", "MD", "MC", "VD", "AE", "DC"], null, ["EF"]),new PayoutConfiguration([new PayoutTax(9, 'ITF')])),
